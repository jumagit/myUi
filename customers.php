        ...
        <div class="container">
            ...
            <div class="page-header">
                <div class="page-title">
                    <h2>All Customers</h2> <span>Good morning, John!</span>
                </div>
                <ul class="page-stats">
                    <li>
            ...
            <div class="row">
                <div class="col-md-12">
                    <p class="alert alert-info"> Please try to resize your browser window in order to see the tables in
                        responsive mode. </p>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <div class="widget box">
                        <div class="widget-header" style="background-color: #3D4E60;color:white;">
                            <h4 style="color:white;"><i class="icon-reorder" style="color:white;"></i> ALL CUSTOMERS
                            </h4>
                            <div class="toolbar ">
